...
Users (first_name, user_name, email)
    (Alyssa, AlyssaHotShot, pepper1@hotshot.com)
    (Hector, HectorHotShot, pepper2@hotshot.com)
    (Josh, JoshHotShot, pepper3@hotshot.com)
    (Josiah, JosiahHotShot, pepper4@hotshot.com)